...
pub fn main() {
    ...
    println!("data={:?}", data);
    let e = abacus_lib::algorithm::symmetric_encryption::sm4::sm4_ecb::sm4_ecb_encrypt_data(&data, key);
    println!("e={:?}", e);
    let de = abacus_lib::algorithm::symmetric_encryption::sm4::sm4_ecb::sm4_ecb_decrypt_data(e.as_slice(), key);
    println!("de={:?}", de);
}
